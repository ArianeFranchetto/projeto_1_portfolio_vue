      ...
      <div class="itens-align">
                <div>
                    <div>
                        ...
                        <div>
                            <input class="style-input" type="text" placeholder="Digite a sua tarefa"
                                value="Estudar Vue 3">
                        </div>
<div class="btn-position">
                        <div>
                            <button class="icon">
                                <svg class="ml-3 h-4 w-4 text-gray-500" viewBox="0 0 24 24" fill="none"
